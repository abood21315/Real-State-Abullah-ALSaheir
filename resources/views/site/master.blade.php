...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('siteassets/fonts/icomoon/style.css') }}" />
    <link rel="stylesheet" href="{{ asset('siteassets/fonts/flaticon/font/flaticon.css') }}" />

    <link rel="stylesheet" href="{{ asset('siteassets/css/tiny-slider.css') }}" />
...
<body>
        ...
        <div class="container">
            <div class="menu-bg-wrap">
                <div class="site-navigation">
                    <a href="{{ route('admin.index') }}" class="logo m-0 float-start">Properties</a>
                    ...
                    <ul class="js-clone-nav d-none d-lg-inline-block text-start site-menu float-end">
                        ...
                        <li class="has-children">
                            ...
                            <ul class="dropdown">
                                ...
                                <li><a href="https://wa.me/+972597274790">Sell Property</a></li>
                            </ul>
                        </li>
    ...
    <address>
        Abdullah Al-Shaer<br>
        Al-Mawasi, Rafah, Gaza
    </address>

    <ul class="list-unstyled links">
        <li>
            <a href="tel:+970597274790">0597274790</a>
        </li>

        <li>
            <a href="tel:+970598855190">0598855190</a>
        </li>

        <li>
            <a href="mailto:zxcbnm2134@gmail.com">
                zxcbnm2134@gmail.com
            </a>
        </li>
    </ul>
</div>
            ...
            <div class="row mt-5">
                <div class="col-12 text-center">
                    <p>
                        ...
                        . All Rights Reserved. &mdash; Designed with Abdullah Alsaheir by
    ...
    <script src="{{ asset('siteassets/js/tiny-slider.js') }}"></script>
